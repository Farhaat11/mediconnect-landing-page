...
const benefits = [
  {
    ...
    description: "Cut patient wait times by up to 40% with intelligent scheduling and streamlined check-in processes.",
    stat: "40%",
  ...
  },
  {
    ...
    description: "Boost patient satisfaction with self-service portals, automated communications, and personalized care plans.",
    stat: "95%",
  ...
  },
  {
    ...
    description: "Stay compliant with HIPAA, GDPR, and other regulations with built-in security and audit trails.",
    stat: "100%",
    statLabel: "Compliant",
  },
  {
    ...
    description: "Automate administrative tasks and reduce paperwork, allowing staff to focus on patient care.",
    stat: "60%",
  ...
  },
  {
    ...
    description: "Enable proactive care with remote monitoring, alerts, and comprehensive health tracking.",
    stat: "3x",
  ...
  },
  {
    ...
    description: "Connect with existing EHR systems, labs, and pharmacies for a unified healthcare ecosystem.",
    stat: "50+",
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16 lg:mb-20">
          ...
          <p className="text-lg text-muted-foreground">
            Join thousands of healthcare providers who have revolutionized their 
            patient care delivery with MediConnect.
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 lg:gap-8 mb-16">
          {benefits.map((benefit) => (
            <div
              key={benefit.title}
              className="group relative bg-card rounded-2xl p-6 lg:p-8 border border-border/50 shadow-soft hover:shadow-elevated transition-all duration-300 overflow-hidden"
            >
              {/* Background Accent */}
        ...
        <div className="gradient-hero rounded-3xl p-8 lg:p-12 text-center relative overflow-hidden">
          ...
          <div className="relative z-10">
            ...
            <p className="text-primary-foreground/80 text-lg max-w-2xl mx-auto mb-8">
              Join 500+ healthcare providers already using MediConnect to deliver 
