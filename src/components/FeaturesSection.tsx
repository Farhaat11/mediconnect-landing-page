import { Calendar, Video, FileText, Pill, Activity, LucideIcon } from "lucide-react";
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16 lg:mb-20">
          ...
          <p className="text-lg text-muted-foreground">
            Our comprehensive platform brings together all essential tools to deliver 
            exceptional patient care while optimizing your workflow.
          </p>
        </div>
